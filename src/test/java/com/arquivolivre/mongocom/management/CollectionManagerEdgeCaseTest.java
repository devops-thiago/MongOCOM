...
class CollectionManagerEdgeCaseTest {
  ...
  void testDocumentWithAllNullFields() {
    ...
    class DocumentWithAllNulls {
      @ObjectId private String id; // null
  ...
  static class DocumentWithMultipleObjectIds {
    @ObjectId private String id1;

    @ObjectId private String id2; // Multiple @ObjectId fields to test warning
  ...
  static class DocumentWithEmptyList {
    ...
    @Internal private List<DocumentWithoutObjectId> internalList;
